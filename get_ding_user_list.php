...
define("APPID", "wx206777fafd7f9f84");
define("SECRET", "21a38d35b688687acf8a11751d2f9883");
//获取access_token
...
foreach($user_list['data']['openid'] as $k=>$v){
	$sql = "select * from xlc_wechat_ding_user_info where openid = '".$v."' limit 1";
	if($GLOBALS['db']->getRow($sql)){
		echo $v.'已经添加过了。<br>';
	}else{
		$tmp_insert_sql = "INSERT INTO xlc_wechat_ding_user_info (`openid`) VALUES ('".$v."')";
